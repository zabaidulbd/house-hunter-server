...
async function run() {
  try {
    const usersCollection = client.db('househunderDb').collection('users')
    const roomsCollection = client.db('househunderDb').collection('rooms')
    const bookingsCollection = client.db('househunderDb').collection('bookings')
